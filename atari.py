...
class Atari:
    ...
    def _main_loop(
        self, game_model, env, render, total_step_limit, total_run_limit, clip
    ):
    ...
    def _args(self):
        ...
        parser.add_argument(
            "-trl",
            "--total_run_limit",
            help="Choose after how many runs we should stop. Default is None (no limit).",
            default=None,
            type=int,
        )
        parser.add_argument(
